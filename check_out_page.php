	...
	<div class="middle_div_othr_pgs_class">
		<div class="menu_main_div_out_container_cls">
			<div class="menu_main_othr_pages_cls">
				<ul class="main_menu_othr_pag_ul_cls">
					...
					<li class="menu_services_li_class" id="websites"> <a href="websites.php" class="menu_main_a_cls menu_border">Websites</a> 
			...
			<div class="about_orange_div_serv_expl_div_cls"  style="left:228px;" id="hosting_orange_div_serv_expl_div_id"><!--------------hosting orange div----->
				...
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Linux Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Fully featured Linux plans with Cpanel, Perl, PHP and more</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Windows Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Complete Windows Hosting with Plesk, IIS and more</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Word Press Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Get your Wordpress blog online now</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>CMS Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Power your website with Drupal, Joomla & more</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>E-Commerce Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Build Ecommerce sites with Zencart, osCommerce & more</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Linux Hosting Reseller</b></a><br>
						<span class="serv_desc_span_tag_clss">Start your Hosting Business powered by WHM today</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Name Suggestion Tool</b></a><br>
						<span class="serv_desc_span_tag_clss">Get help picking a domain name</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Windows Reseller Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Start your Hosting Business with Plesk today</span> </div>
				</div>
			</div>
			...
			<div class="about_orange_div_serv_expl_div_cls"  style="left:366px;width:230px;height:80px;" id="vps_orange_div_serv_expl_div_id">
				<div class="serv_each_div_in_menu_sub_cls" style="border:0px;">
					<div class="float_left"> <a href="#"><b>VPS Hosting</b></a><br>
						<span class="serv_desc_span_tag_clss">Cutting edge VPS Hosting with Virtuozzo, NetApp & more</span> </div>
				</div>
			</div>
			<!-------------------------build a website orange div------->
			<div class="about_orange_div_serv_expl_div_cls"  style="left:492px;width:215px;" id="websites_orange_div_serv_expl_div_id">
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Do it yourself website Builder</b></a><br>
						<span class="serv_desc_span_tag_clss">Build your website in minutes using our DIY tools</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Find web designers</b></a><br>
						<span class="serv_desc_span_tag_clss">Find top web designers in your city and your budget</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls" style="border:0px;">
					<div class="float_left"> <a href="#"><b>Digicerts & SSL</b></a><br>
						<span class="serv_desc_span_tag_clss">Secure your Website</span> </div>
				</div>
			</div>
			<!-------------------------websites orange div-------> 
			...
			<div class="about_orange_div_serv_expl_div_cls"  style="left:615px;width:215px;height:150px;" id="email_orange_div_serv_expl_div_id">
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Get a personal Email</b></a><br>
						<span class="serv_desc_span_tag_clss">Get email@yourdomain.com for home</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls" style="border:0px;">
					<div class="float_left"> <a href="#"><b>Business Email</b></a><br>
						<span class="serv_desc_span_tag_clss">Get email@yourdomain.com for your business</span> </div>
				</div>
			</div>
			<!-------------------------email orange div-------> 
			...
			<div class="about_orange_div_serv_expl_div_cls"  style="left:739px;width:215px;height:295px;" id="partner_orange_div_serv_expl_div_id">
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Affiliate Program</b></a><br>
						<span class="serv_desc_span_tag_clss">Earn BIG commissions with ZERO investment</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Design Xchange Program</b></a><br>
						<span class="serv_desc_span_tag_clss">Sign up now to get FREE web design leads</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls">
					<div class="float_left"> <a href="#"><b>Refer a friend Program</b></a><br>
						<span class="serv_desc_span_tag_clss">Invite friends and get FREE renewals</span> </div>
				</div>
				<div class="serv_each_div_in_menu_sub_cls" style="border:0px;">
					<div class="float_left"> <a href="#"><b>Private Labelled Reseller Program</b></a><br>
						<span class="serv_desc_span_tag_clss">Start a full-fledged Reseller business</span> </div>
				</div>
			</div>
			<!-------------------------partner orange div-------> 
		...
		<div class="available_domains_div_cls">
			<div class="search_results_txt_cls" >
				<div style="float:left">You need to login/signup to proceed for payment</div>
			</div>
			<div class="new_usrs_reg_div_cls" id='overflow_div' style="height:267px;overflow:hidden;position:relative;">
				<div class="sign_up_upper_div_cls">
					<div  class="img_new_usr_sgn_up_cls"> <img src="images/signup_icon.png" /> </div>
					<div class="clk_nw_usr"> <span class="clk_hr_span">Click Here to Signup if you are a new user</span> </div>
				</div>
				<div class="usr_div_header_class"> New user Signup! </div>
				<div class="input_bxs_new_user_class">
					<div class="pls_clk_sngp_cls">Please enter your details & click on signup!</div>
					<input type="text" class="input_class_new_usr_div_cls" placeholder="Name"/>
					<br>
					<div class="pass_txt">Will be used as your username</div>
					<input type="text" class="input_class_new_usr_div_cls" placeholder="Address"/>
					<br>
					<input type="email" class="input_class_new_usr_div_cls" placeholder="Email"/>
					<br>
					<input type="password" class="input_class_new_usr_div_cls" placeholder="Password"/>
					<br>
					<div class="pass_txt">Password should be minimum 8 characters long</div>
					<input type="password" class="input_class_new_usr_div_cls" placeholder="Confirm Password"/>
					<br>
					<input type="text" class="input_class_new_usr_div_cls" style="width:30px;"/>
					<input type="text" class="input_class_new_usr_div_cls" style="width:215px;margin-left:10px;" placeholder="Phone Number"/>
					<br>
					<div class="pass_txt">Country Code + Phone Number</div>
					<input type="text" class="input_class_new_usr_div_cls" placeholder="City"/>
					<br>
					<input type="text" class="input_class_new_usr_div_cls" placeholder="Zip Code"/>
					<br>
					<div class="signup_btn_chk_paeg_cls"> Signup </div>
				</div>
			</div>
			<div class="new_usrs_reg_div_cls" style="margin-left:20px;">
				<div class="usr_div_header_class"> Existing Users </div>
				<div class="input_bxs_new_user_class">
					<input type="text" class="input_class_new_usr_div_cls" placeholder="User Name"/>
					<br>
					<input type="text" class="input_class_new_usr_div_cls" placeholder="Password"/>
					<br>
					<div class="float_left" style="margin-top:10px;width:260px;">
						<input type="checkbox" style="float:left;"/>
						<div class="remmeber_me_txt_cls">Remember Me</div>
						<div class="frgt_pass_cls"><a href="#">Forgot Password?</a></div>
					</div>
					<div class="signup_btn_chk_paeg_cls"> Login </div>
				</div>
			</div>
			<div class="search_results_txt_cls fbdivs" style="margin:20px 0px 10px 0px;height:180px;line-height:16px;">
				<div class="left_div_detls_stf_cls">
					<div class="sub_ttl_div_cls" style="padding-left:10px;">
						<div class="float_left">Sub Total: </div>
						<div class="float_right">Rs. 908/-</div>
					</div>
					<div class="sub_ttl_div_cls" style="padding-left:10px;">
						<div class="float_left"> Tax: <span title="taxes applicable as per country" style="color:#777;cursor:pointer;">(?)</span> </div>
						<div class="float_right"> Rs. 89/- </div>
					</div>
					<div class="sub_ttl_div_cls" style="border-top:1px solid #bababa;background:#feffd5;margin-top: 3px;padding: 10px 10px 1px 10px;">
						<div class="float_left"> <span style="font-size:15px;">Total Amount:</span> </div>
						<div class="float_right"> Rs. 989/- </div>
					</div>
				</div>
				<div class="right_div_stf_cls">
					<div class="sigup_with_button_class" style="background:#3b559f;">
						<div class="icon_container_class" style="padding-top:4px;"> <img src="images/facebook.png"/> </div>
						<div class="signup_with_text_div_class">Facebook</div>
					</div>
					<div class="sigup_with_button_class" style="margin-left:10px;background:#33ccff;">
						<div class="icon_container_class" > <img src="images/twitter_logo.png"/> </div>
						<div class="signup_with_text_div_class">Twitter</div>
					</div>
					<div class="disc_txt_cls"> 
						<span style="font-size:12px;font-weight:bold;">
							Singup with your facebook/twitter account to get upto 10% off on this order instantly
						</span> <br>
						<p>*Discounts not applicable on .BIZ domains, 
						Premium Domains & VPS Hosting </p></div>
					<div class="gt_cpn">Got Coupon?</div>
					<input type="text" class="coupon_div_cls" placeholder="enter coupon code"/>
					<div class="apply_coupon_button_class"> <span class="apply_spn_cls">Apply>></span> </div>
				</div>
			</div>
			<div class="search_results_txt_cls" style="margin-top:10px;">
				<div style="float:left">Your Order Summary</div>
			</div>
			<div class="each_price_tile_class" style="width:600px;">
				<div class="dom_name_class" style="padding:0px 10px;width:auto;background:#5fa233;"> somethinguseful.com </div>
			...
			<div class="each_price_tile_class" style="width:600px;">
				<div class="hosting_Desc_class"> <Span style="font-weight:bold;" id="hosting_name_span_id">Advanced Single Linux Hosting</span><br>
					<span id="hosting_desc_span">Unlimited Space | Unlimited Emails | Unlimited Transfer</span> </div>
				<div class="select_div_cont_cls">
					<select>
						<option>1yr @ Rs.589/-</option>
						<option>2yr @ Rs.689/-</option>
